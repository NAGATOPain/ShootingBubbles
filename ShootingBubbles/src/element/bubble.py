...
class Bubble:
	# Bubble has 3 level: 1, 2, 3. Level 3 has its size biggest, and level 1 has its size smallest
	# If shoot in a bubble which has level > 1 then its level decrease by 1
	# If shoot in a bubble which has level = 1 then it disappear
	...
	__SPEED = 2.5
	__RANGE = 100.0 # The range of screen that bubble is in
	...
	def __init__(self, display, w_size, former_pos = None, level = None):
		...
		# Set a variable check whether bubble is out of screen
		self.__is_out = False
